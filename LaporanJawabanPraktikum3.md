...
Jawab : Fungsi tanpa nama yang dapat didefinisikan langsung di tempat dan digunakan untuk operasi yang cepat atau sementara. Fungsi anonim digunakan untuk fungsi sederhana dan tidak perlu dideklarasikan secara eksplisit dengan nama.
...
- Menggunakan Records : mengembalikan beberapa nilai dengan tipe data berbeda tanpa harus membuat kelas atau struktur data lain.
``` dart
